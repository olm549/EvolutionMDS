...
@Table(name="Listas_de_reproduccion2")
public class Listas_de_reproduccion2 implements Serializable {
	public Listas_de_reproduccion2() {
	}
	
	private java.util.Set this_getSet (int key) {
		if (key == ORMConstants.KEY_LISTAS_DE_REPRODUCCION2_VIDEOS_EN_LISTA) {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_LISTAS_DE_REPRODUCCION2_USUARIO_REGISTRADO) {
			this.usuario_registrado = (database.Usuario_registrado) owner;
		}
		
		else if (key == ORMConstants.KEY_LISTAS_DE_REPRODUCCION2_USUARIO_QUE_CONSULTA_HISTORIAL) {
	...
	@Id	
	@GeneratedValue(generator="DATABASE_LISTAS_DE_REPRODUCCION2_ID_LISTA_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DATABASE_LISTAS_DE_REPRODUCCION2_ID_LISTA_GENERATOR", strategy="native")	
	private int id_lista;
	
	@OneToOne(optional=false, targetEntity=database.Usuario_registrado.class, fetch=FetchType.LAZY)	
	...
	@Transient	
	public final database.VideosSetCollection videos_en_lista = new database.VideosSetCollection(this, _ormAdapter, ORMConstants.KEY_LISTAS_DE_REPRODUCCION2_VIDEOS_EN_LISTA, ORMConstants.KEY_VIDEOS_LISTAS_DE_VIDEOS, ORMConstants.KEY_MUL_MANY_TO_MANY);
	...
	public java.util.List cargar_Listas_Reproduccion(int ID_Usuario) {
