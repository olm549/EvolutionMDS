...
public class Categorias2 implements Serializable {
	...
	private java.util.Set this_getSet (int key) {
		if (key == ORMConstants.KEY_CATEGORIAS2_VIDEOS) {
			return ORM_videos;
		}
	...
	@Id	
	@GeneratedValue(generator="DATABASE_CATEGORIAS2_ID_CATEGORIA_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DATABASE_CATEGORIAS2_ID_CATEGORIA_GENERATOR", strategy="native")	
	...
	@Transient	
	public final database.VideosSetCollection videos = new database.VideosSetCollection(this, _ormAdapter, ORMConstants.KEY_CATEGORIAS2_VIDEOS, ORMConstants.KEY_VIDEOS_CATEGORIA, ORMConstants.KEY_MUL_ONE_TO_MANY);
